    ...
    <main className="flex min-h-full flex-col bg-[#0c0d10]">
      ...
      <section className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-start px-6 pt-24 pb-20">
        ...
        >
          ...
          <button
            type="submit"
            className="flex shrink-0 cursor-pointer items-center gap-2 rounded-r-lg bg-[#818cf8] px-4 py-3 text-sm font-semibold text-white transition-colors duration-150 hover:bg-[#6366f1]"
          >
            Visualize
