    ...
    >
      <div className="w-full max-w-xl animate-fade-in rounded-xl border border-line bg-surface">
            ...
            <span className={finished ? "text-ok" : failed ? "text-err" : "text-faint"}>
              <svg viewBox="0 0 16 16" className="h-4 w-4" fill="currentColor" aria-hidden="true">
                {finished ? (
                  ...
                  <path fillRule="evenodd" d="M8 1a7 7 0 1 1 0 14A7 7 0 0 1 8 1zm-.75 3.75a.75.75 0 0 1 1.5 0v3.5a.75.75 0 0 1-1.5 0v-3.5zM8 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" clipRule="evenodd" />
                ) : (
        ...
        <div className="border-b border-line px-4 py-2">
          <span className="font-mono text-[12px] text-faint">{repo}</span>
        </div>
