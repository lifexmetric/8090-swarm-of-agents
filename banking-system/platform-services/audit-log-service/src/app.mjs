...
export const serviceName = "audit-log-service";
export const domain = "Platform Services";
export const endpoint = "/v1/audit/events";
...
export const topics = {
  produces: ["audit.event.recorded"],
  consumes: ["identity.login.succeeded", "ledger.entry.posted", "case.created"],
};
