...
export const serviceName = "observability-collector-service";
export const domain = "Platform Services";
export const endpoint = "/v1/observability/signals";
...
export const topics = {
  produces: ["observability.signal.received"],
  consumes: ["mesh.route.changed"],
};
