...
export const serviceName = "secrets-broker-service";
export const domain = "Platform Services";
export const endpoint = "/v1/secrets/leases";
...
export function buildSyntheticTransaction(input = {}) {
  return {
    ...
    downstreamServices: ["audit-log-service"],
  };
}
