...
export const serviceName = "card-authorization-service";
export const domain = "Payments And Rails";
export const endpoint = "/v1/cards/authorizations";
...
export const topics = {
  produces: ["card.authorization.approved", "payment.authorized"],
  consumes: ["atm.withdrawal.requested"],
};
...
export function buildSyntheticTransaction(input = {}) {
  return {
    ...
    downstreamServices: ["core-ledger-service", "fraud-rules-service", "session-risk-service"],
  };
}
