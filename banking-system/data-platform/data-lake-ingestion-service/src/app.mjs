...
export const serviceName = "data-lake-ingestion-service";
export const domain = "Data And Analytics";
export const endpoint = "/v1/data-lake/ingest";
...
export const topics = {
  produces: ["data.lake.object.created"],
  consumes: ["ledger.entry.posted", "customer.profile.updated", "payment.authorized"],
};
