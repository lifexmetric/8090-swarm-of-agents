...
export const serviceName = "transaction-monitoring-service";
export const domain = "Risk And Compliance";
export const endpoint = "/v1/monitoring/transactions";
...
export const topics = {
  produces: ["transaction.monitoring.alert"],
  consumes: ["ledger.entry.posted", "payment.authorized"],
};
